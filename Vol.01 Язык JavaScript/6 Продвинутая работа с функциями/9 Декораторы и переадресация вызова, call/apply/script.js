...
но ваше решение должно передаватьвсе аргументы и контекст this.
*/
...
function debounce(f, ms) {
  ...
  return function() {
    ...
    setInterval(() => isCollDown = false, ms);
  }
}
...
setTimeout( () => f1(3), 100);
setTimeout( () => f1(4), 1100);
setTimeout( () => f1(5), 1500);
